...
else if (global.levelcomplete && (!global.chateaucutscene))
{
    ...
    currentroom = room
    scene_info = [[gml_Script_cutscene_entrance_start], [gml_Script_cutscene_waitfor_sprite, obj_player1], [gml_Script_cutscene_player_idleanim], [gml_Script_cutscene_change_room, hub_warpath], [gml_Script_cutscene_set_player_visible, 0], [gml_Script_cutscene_set_player_pos, 1888, 369], [gml_Script_cutscene_wait, 100], [gml_Script_cutscene_change_room, currentroom], [gml_Script_cutscene_set_player_visible, 1], [function() //gml_Script_anon@1494@gml_RoomCC_hub_medievallobby_7_Create
    {
        with (obj_player)
        {
            state = states.normal
