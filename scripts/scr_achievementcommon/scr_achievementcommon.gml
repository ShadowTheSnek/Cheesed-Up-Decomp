...
{
    var b = add_achievement_notify(concat("secrets", argument0), -4, function(argument0) //gml_Script_anon@123@add_secrets_achievement_scr_achievementcommon
    {
...
{
    b = add_achievement_notify(concat(argument1, "ranks", argument0), -4, function(argument0) //gml_Script_anon@776@add_rank_achievements_scr_achievementcommon
    {
        type = argument0[0]
        if (type == (5 << 0))
        {
...
{
    b = add_achievement_notify(argument0, -4, function(argument0) //gml_Script_anon@1717@add_boss_achievements_scr_achievementcommon
    {
        type = argument0[0]
        var arr = argument0[1]
...
{
    active = 0
    function anon@2089@scr_custom_notification_destructibles_scr_achievementcommon() //gml_Script_anon@2089@scr_custom_notification_destructibles_scr_achievementcommon
    {
        if (!active)
        {
