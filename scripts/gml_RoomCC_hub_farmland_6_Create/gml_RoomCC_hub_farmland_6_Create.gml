...
{
    currentroom = room
    scene_info = [[gml_Script_cutscene_entrance_start], [gml_Script_cutscene_waitfor_sprite, obj_player1], [gml_Script_cutscene_player_idleanim], [gml_Script_cutscene_change_room, hub_superpinball], [gml_Script_cutscene_set_player_visible, 0], [gml_Script_cutscene_player_float, 1], [gml_Script_cutscene_set_player_pos, 966, 274], [gml_Script_cutscene_wait, 10], [gml_Script_cutscene_farm_middle], [gml_Script_cutscene_change_room, hub_golf], [gml_Script_cutscene_player_float, 1], [gml_Script_cutscene_set_player_pos, 555, 370], [gml_Script_cutscene_wait, 10], [gml_Script_cutscene_farm_middle], [gml_Script_cutscene_change_room, currentroom], [gml_Script_cutscene_player_float, 0], [gml_Script_cutscene_set_player_visible, 1], [gml_Script_cutscene_farm_end], [gml_Script_cutscene_save_game]]
}
else if global.levelcomplete
{
    global.levelcomplete = 0
