...
ag_dialog[1] = [dialog_create("Meet me outside the factory wall", -4, function() //gml_Script_anon@198@gml_RoomCC_hub_pizzaland_4_Create
{
    global.anarchistcutscene1 = 1
    quick_ini_write_real(get_savefile_ini(), "cutscene", "anarchist1", 1)
}
)]
function anon@345@gml_RoomCC_hub_pizzaland_4_Create() //gml_Script_anon@345@gml_RoomCC_hub_pizzaland_4_Create
{
