...
g_dialog[1] = [dialog_create("The robot is busted", -4, function() //gml_Script_anon@151@gml_RoomCC_hub_warpath_3_Create
{
...
g_dialog[3] = [dialog_create("Go right ahead", -4, function() //gml_Script_anon@434@gml_RoomCC_hub_warpath_3_Create
{
...
function anon@675@gml_RoomCC_hub_warpath_3_Create() //gml_Script_anon@675@gml_RoomCC_hub_warpath_3_Create
{
