function create_transformation_tip(argument0, argument1, argument2) //gml_Script_create_transformation_tip
{
    ...
    var b = -4
    with (gml_Script_instance_create(0, 0, obj_transfotip, 
    {
        destroy: argument2
    }
))
...
function scr_draw_granny_texture(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) //gml_Script_scr_draw_granny_texture
{
    ...
    if (!surface_exists(surfclip))
        surfclip = surface_create_fix(w, h)
    if (!surface_exists(surffinal))
        surffinal = surface_create_fix(w, h)
    ...
    draw_sprite_tiled(argument6, 0, (argument4 + argument8), (argument5 + argument9))
    gpu_set_blendmode(bm_subtract)
