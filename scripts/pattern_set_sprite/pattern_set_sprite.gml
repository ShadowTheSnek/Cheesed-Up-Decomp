function pattern_set_sprite(argument0, argument1, argument2, argument3, argument4, argument5) //gml_Script_pattern_set_sprite
{
    ...
    shader_set_uniform_f(shader_get_uniform(shd_pal_swapper, "pattern_offset"), argument4, argument5)
}
