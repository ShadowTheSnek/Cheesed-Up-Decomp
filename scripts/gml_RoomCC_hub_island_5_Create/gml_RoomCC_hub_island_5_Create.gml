...
pm_scene_info = [[gml_Script_cutscene_do_dialog, [dialog_create("Here you go")]], [gml_Script_cutscene_waitfor_dialog], [gml_Script_cutscene_set_player_actor], [gml_Script_cutscene_set_object_pos, 151071, 1696, 576], [gml_Script_cutscene_do_dialog, [dialog_create("Go ahead", -4, function() //gml_Script_anon@403@gml_RoomCC_hub_island_5_Create
{
}
)]]]
function anon@443@gml_RoomCC_hub_island_5_Create() //gml_Script_anon@443@gml_RoomCC_hub_island_5_Create
{
