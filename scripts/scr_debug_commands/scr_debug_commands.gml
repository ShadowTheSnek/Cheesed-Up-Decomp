function _string_split(argument0, argument1) //gml_Script__string_split
{
    argument0 += " "
    var _current_str = ""
    var _list = [0]
...
function DebugCommand(argument0, argument1, argument2, argument3) constructor //gml_Script_DebugCommand
{
    ...
    format = argument2
    func = argument3
    function anon@1337@DebugCommand_scr_debug_commands(argument0) //gml_Script_anon@1337@DebugCommand_scr_debug_commands
    {
