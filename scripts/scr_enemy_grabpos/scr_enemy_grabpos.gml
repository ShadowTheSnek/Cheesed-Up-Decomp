function scr_enemy_grabpos(argument0) //gml_Script_scr_enemy_grabpos
{
    var p = argument0
    ...
    else
    {
        ...
        if (p.sprite_index != p.spr_haulingstart)
        {
            if (p.character == "SP")
            {
                ...
                {
                    if (floor(p.image_index) == 0 || floor(p.image_index) == 4)
                        y -= 3
                    if (floor(p.image_index) == 1 || floor(p.image_index) == 5)
                        y += 2
                    if (floor(p.image_index) == 2 || floor(p.image_index) == 6)
                        y += 7
                    if (floor(p.image_index) == 3 || floor(p.image_index) == 7)
                        y += 3
                }
        ...
        else if (p.character == "SP" && p.image_index < 6)
        {
            if (floor(p.image_index) == 0)
                y += 48
