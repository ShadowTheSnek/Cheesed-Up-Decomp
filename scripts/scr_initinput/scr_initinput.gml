function ini_read_input(argument0, argument1, argument2) //gml_Script_ini_read_input
{
    var result = ini_read_string(argument0, argument1, argument2)
...
function scr_initinput(argument0) //gml_Script_scr_initinput
{
    ...
    tdp_input_ini_read("player_chainsaw", [tdp_action((0 << 0), 86)])
    ...
    tdp_input_ini_read("player_chainsawC", [tdp_action((1 << 0), 32773), tdp_action((1 << 0), 32775)])
