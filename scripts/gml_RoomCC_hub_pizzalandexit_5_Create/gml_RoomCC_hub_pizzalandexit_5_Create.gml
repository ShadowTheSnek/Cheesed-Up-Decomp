...
ef_dialog[1] = [dialog_create("Is that beer I see? Go right ahead", -4, function() //gml_Script_anon@151@gml_RoomCC_hub_pizzalandexit_5_Create
{
...
function anon@403@gml_RoomCC_hub_pizzalandexit_5_Create() //gml_Script_anon@403@gml_RoomCC_hub_pizzalandexit_5_Create
{
