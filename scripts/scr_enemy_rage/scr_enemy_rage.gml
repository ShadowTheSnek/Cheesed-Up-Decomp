function scr_enemy_rage() //gml_Script_scr_enemy_rage
{
    switch object_index
    {
        ...
        case obj_smokingpizzaslice:
            ...
            {
                with (gml_Script_instance_create((x + (image_xscale * 70)), (y + 8), obj_parryeffect))
                {
                ...
                shot = 1
                with (gml_Script_instance_create((x + (image_xscale * 15)), (y + 5), obj_slugbullet))
                    image_xscale = other.image_xscale
            }
            if (floor(image_index) == (image_number - 1))
            {
        ...
        case obj_indiancheese:
            ...
            if ((!shot) && ragedash < 30)
            {
                ...
                shot = 1
                with (gml_Script_instance_create(x, y, obj_arcprojectile))
                {
                    image_xscale = other.image_xscale
                    hsp = (image_xscale * 6)
                    vsp = -11
        ...
        case obj_miniufo:
            ...
            {
                shoot = 1
                gml_Script_instance_create(x, y, obj_warplaserhoming)
            }
            if (floor(image_index) == (image_number - 1))
                state = states.walk
            break
        case obj_cheeseslime:
            ...
            {
                hsp = (image_xscale * 8)
                with (gml_Script_instance_create(x, y, obj_baddieragehitbox))
                {
                    ID = other.id
                    image_xscale = other.image_xscale
                }
        ...
        case obj_spitcheese:
            ...
            if (ragedash <= 0)
            {
                with (gml_Script_instance_create(x, y, obj_bigspitcheesespike))
                {
                    other.ragedash = 50
