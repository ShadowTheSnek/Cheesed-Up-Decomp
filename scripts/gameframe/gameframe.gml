...
function() //gml_Script_anon@997@gameframe
{
...
function gameframe_update() //gml_Script_gameframe_update
{
    ...
    global.gameframe_mouse_over_frame = 0
...
function game_frame_button_create(argument0, argument1, argument2, argument3) //gml_Script_game_frame_button_create
{
    ...
    _this[15] = gml_Script_game_frame_button_draw_icon_default
    _this[14] = gml_Script_game_frame_button_draw_underlay_default
    _this[13] = gml_Script_game_frame_button_update_default
    _this[12] = gml_Script_game_frame_button_get_width_default
    _this[10] = 0
    _this[9] = 1
    _this[8] = 0
    _this[7] = 0
...
{
    __g = 0
    __g1 = global.gameframe_button_array
    while (__g < array_length(__g1))
    {
        _b = __g1[__g]
        __g++
...
function gameframe_button_update(argument0, argument1, argument2, argument3, argument4) //gml_Script_gameframe_button_update
{
    ...
    if global.gameframe_button_wait_for_movement
    {
        if (argument3 != global.gameframe_button_wait_for_movement_x || argument4 != global.gameframe_button_wait_for_movement_y)
            global.gameframe_button_wait_for_movement = 0
        else
            _over_row = 0
    }
    ...
    var _i = 0
    __g1 = array_length(global.gameframe_button_array)
    while (_i < __g1)
    {
...
{
    _dpiScale = global.gameframe_effective_scale
    _i = 0
    __g1 = array_length(global.gameframe_button_array)
    while (_i < __g1)
    {
        _button = global.gameframe_button_array[_i]
        argument0 += (_button[5] * _dpiScale)
        _width = (self._button[12](_button) * _dpiScale)
...
function gameframe_button_add_defaults() //gml_Script_gameframe_button_add_defaults
{
    ...
    var _minimize = game_frame_button_create("minimize", global.gameframe_spr_buttons, 0, function(argument0) //gml_Script_anon@20225@gameframe_button_add_defaults_gameframe
    {
        gameframe_minimize()
    }
)
    ...
    var _maxrest = game_frame_button_create("maxrest", global.gameframe_spr_buttons, 1, function(argument0) //gml_Script_anon@20478@gameframe_button_add_defaults_gameframe
    {
        if global.gameframe_isMaximized_hx
            gameframe_restore()
        else
    ...
    function anon@20644@gameframe_button_add_defaults_gameframe(argument0) //gml_Script_anon@20644@gameframe_button_add_defaults_gameframe
    {
    ...
    var _close = game_frame_button_create("close", global.gameframe_spr_buttons, 3, function(argument0) //gml_Script_anon@20893@gameframe_button_add_defaults_gameframe
    {
        game_end()
    }
)
    function anon@20963@gameframe_button_add_defaults_gameframe(argument0, argument1, argument2, argument3, argument4) //gml_Script_anon@20963@gameframe_button_add_defaults_gameframe
    {
        var __alpha = 0
        if argument0[8]
        {
...
function gameframe_minimize() //gml_Script_gameframe_minimize
{
    if gml_Script_gameframe_is_natively_minimized()
        return;
    gameframe_button_reset()
    gameframe_delayed_call_impl(function() //gml_Script_anon@23469@gameframe_minimize_gameframe
    {
        global.gameframe_button_wait_for_movement = 1
...
function gameframe_minimise() //gml_Script_gameframe_minimise
{
    ...
    {
        gameframe_button_reset()
        gameframe_delayed_call_impl(function() //gml_Script_anon@23909@gameframe_minimise_gameframe
        {
            global.gameframe_button_wait_for_movement = 1
            global.gameframe_button_wait_for_movement_x = window_mouse_get_x()
            global.gameframe_button_wait_for_movement_y = window_mouse_get_y()
...
function gameframe_maximize() //gml_Script_gameframe_maximize
{
    if (global.gameframe_isMaximized_hx || global.gameframe_isFullscreen_hx || window_get_fullscreen())
        return;
    global.gameframe_isMaximized_hx = 1
...
function gameframe_restore(argument0) //gml_Script_gameframe_restore
{
    ...
    if window_get_fullscreen()
    {
        ...
        gameframe_delayed_call_impl(function() //gml_Script_anon@26046@gameframe_restore_gameframe
        {
            gameframe_restore()
        }
, 1, undefined, undefined, undefined, undefined)
    ...
    if ((!argument0) && (!global.gameframe_isMaximized_hx) && (!global.gameframe_isFullscreen_hx))
        return;
    global.gameframe_isMaximized_hx = 0
    global.gameframe_isFullscreen_hx = 0
...
function gameframe_set_fullscreen_1(argument0, argument1) //gml_Script_gameframe_set_fullscreen_1
{
    ...
    switch argument0
    {
        case 1:
            ...
            {
                gameframe_restore()
                gameframe_delayed_call_impl(function() //gml_Script_anon@27650@gameframe_set_fullscreen_1_gameframe
                {
...
, 1, undefined, undefined, undefined, undefined)
        ...
        case 2:
            ...
            {
                window_set_fullscreen(false)
                gameframe_delayed_call_impl(function() //gml_Script_anon@27959@gameframe_set_fullscreen_1_gameframe
                {
                    gameframe_set_fullscreen_1(2, 1)
                }
, 10, undefined, undefined, undefined, undefined)
            ...
            if global.gameframe_isFullscreen_hx
                return;
            global.gameframe_isFullscreen_hx = 1
        ...
        default:
            ...
            {
                window_set_fullscreen(false)
                gameframe_delayed_call_impl(function() //gml_Script_anon@28525@gameframe_set_fullscreen_1_gameframe
                {
...
function gameframe_caption_get_overlap() //gml_Script_gameframe_caption_get_overlap
{
    if (window_get_fullscreen() || global.gameframe_isFullscreen_hx)
        return 0;
    _h = gameframe_caption_get_height()
...
function gameframe_caption_draw_caption_text_default(argument0, argument1, argument2, argument3) //gml_Script_gameframe_caption_draw_caption_text_default
{
    ...
    _icon = global.gameframe_caption_icon
    if (_icon != -1)
    {
...
function gameframe_cover_ensure() //gml_Script_gameframe_cover_ensure
{
    ...
    if __just_changed
        global.gameframe_cover_check_for_success = 0
    if window_get_fullscreen()
    {
        global.gameframe_cover_can_ignore = 0
        return;
    }
    ...
    if (!(gameframe_tools_rect_equals(global.gameframe_cover_curr_rect, __target_rect)))
    {
        if __just_changed
        {
            global.gameframe_cover_can_ignore = 1
        ...
        global.gameframe_cover_check_for_success = 1
    }
}
...
{
    _this = [global.mt_gameframe_delayed_item]
...
{
    _i = 0
    __g1 = array_length(global.gameframe_tools_keyctl_keys)
    while (_i < __g1)
    {
        global.gameframe_tools_keyctl_keys[_i][1] = 0
        _i++
    }
}
...
function gameframe_draw() //gml_Script_gameframe_draw
{
    ...
    if (window_get_fullscreen() || global.gameframe_isFullscreen_hx)
        return;
    _gw = window_get_width()
    _gh = window_get_height()
    display_set_gui_maximise((browser_width / _gw), (browser_height / _gh), ((_gw % 2) / -2), ((_gh % 2) / -2))
    __borderWidth = (global.gameframe_isMaximized_hx ? 0 : global.gameframe_border_width)
    var __titlebarHeight = gameframe_caption_get_height()
    __buttons_x = gameframe_button_get_combined_offset(_gw)
    if (!global.gameframe_isMaximized_hx)
        @@Global@@().global.gameframe_caption_draw_border(0, 0, _gw, _gh)
    @@Global@@().global.gameframe_caption_draw_background(__borderWidth, __borderWidth, (_gw - (__borderWidth * 2)), __titlebarHeight, __buttons_x)
    @@Global@@().global.gameframe_caption_draw_text(__borderWidth, __borderWidth, (__buttons_x - __borderWidth), __titlebarHeight)
...
global.gameframe_has_native_extension = 0
global.gameframe_mouse_over_frame = 0
global.gameframe_isMaximized_hx = 0
global.gameframe_isFullscreen_hx = 0
