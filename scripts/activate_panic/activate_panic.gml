function calculate_panic_timer(argument0, argument1) //gml_Script_calculate_panic_timer
{
    if (argument0 == undefined)
        argument0 = 5
    if (argument1 == undefined)
        argument1 = 30
    return ((((argument0 * 60) + argument1) * 60) * 0.2);
}

function activate_panic(argument0, argument1) //gml_Script_activate_panic
{
    if (argument0 == undefined)
        argument0 = 0
    if (argument1 == undefined)
    ...
    if (!argument0)
    {
        ...
        with (instance_create_unique(0, 0, obj_hungrypillarflash))
            debrisid = argument1
        gml_Script_instance_create(0, 0, obj_itspizzatime)
        with (obj_camera)
        {
            alarm[1] = 60
            shake_mag = 3
    ...
    else
    {
        switch room
        {
            ...
            case chateau_9:
                ...
                layer_background_sprite(layer_background_get_id_fix(lay), spr_chateaudarkbg_escape)
                global.fill = 2520
                break
            case kidsparty_john:
                global.fill = 2460
            ...
            case entryway_11:
                ...
                break
            case steamy_12:
                global.fill = calculate_panic_timer(3, 0)
                break
            case molasses_9:
                global.fill = calculate_panic_timer(3, 0)
                break
    ...
    if (global.MOD.Pacifist || global.MOD.NoToppings)
        global.fill *= 3
    with (obj_tv)
    {
...
function activate_snickchallenge() //gml_Script_activate_snickchallenge
{
