    ...
    switch supergrabstate
    {
        case (80 << 0):
            ...
            if (floor(image_index) == (image_number - 1))
            {
                ...
                if hiteffect
                {
                    with (gml_Script_instance_create((midpointX + irandom_range(-5, 5)), (midpointY + irandom_range(-5, 5)), obj_explosioneffect))
                    {
                        image_speed = 0.4
                        depth = -20
                ...
                if (punchcount > 0)
                {
                    ...
                    with (baddiegrabbedID)
                    {
                        ...
                        gml_Script_instance_create((midpointX + irandom_range(-5, 5)), (midpointY + irandom_range(-5, 5)), obj_parryeffect)
                    }
                    image_index = 1
                    image_speed = 0
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        state = states.finale
                        gml_Script_instance_create((room_width / 2), (room_height / 2), obj_pizzahead_finalecutscene)
            ...
            if (floor(image_index) >= 0 && (!shot))
            {
                ...
                with (baddiegrabbedID)
                {
                    ...
                    if other.pizzahead
                        ...
                        hitLag = 5
                    with (gml_Script_instance_create(midpointX, midpointY, obj_explosioneffect))
                    {
