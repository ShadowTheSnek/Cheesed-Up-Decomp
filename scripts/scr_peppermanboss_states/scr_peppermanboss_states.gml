...
function pepperman_decide_attack_phase5() //gml_Script_pepperman_decide_attack_phase5
{
    ...
    else
    {
        ...
        groundpound_fakeout = 1
        readjusting = 0
        state = (irandom(100) > 50 ? choose((128 << 0), (128 << 0), (83 << 0)) : states.jump)
        if (state == (128 << 0))
        {
            sprite_index = spr_pepperman_shoulderstart
            image_index = 0
...
{
    gml_Script_instance_create((room_width / 2), -64, obj_peppermanbrick)
    gml_Script_instance_create((room_width / 5), -64, obj_peppermanbrick)
    gml_Script_instance_create((room_width - (room_width / 5)), -64, obj_peppermanbrick)
}
