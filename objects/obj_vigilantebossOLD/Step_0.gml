...
attacking = (state == states.revolver || state == states.mach1 || state == (128 << 0) || state == states.punch || state == (164 << 0) || state == (166 << 0) || state == states.freefall || state == states.uppunch || state == states.handstandjump || state == (160 << 0) || state == (158 << 0) || state == states.crouchslide)
