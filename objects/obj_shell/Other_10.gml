variable_global_set("sh_help", function(argument0) //gml_Script_anon@111@gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
        var helpFunction = argument0[1]
        if allFunctions.allFunctions._array_contains(helpFunction, self)
        {
...
variable_global_set("meta_help", function() //gml_Script_anon@2236@gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_clear", function(argument0) //gml_Script_anon@2562@gml_Object_obj_shell_Other_10
{
...
variable_global_set("meta_clear", function() //gml_Script_anon@2979@gml_Object_obj_shell_Other_10
{
    return 
    {
        arguments: ["<all>"],
...
variable_global_set("sh_shell_set_width", function(argument0) //gml_Script_anon@3311@gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
...
variable_global_set("meta_shell_set_width", function() //gml_Script_anon@3601@gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_height", function(argument0) //gml_Script_anon@3881@gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
        if (string_digits(argument0[1]) != "")
...
variable_global_set("meta_shell_set_height", function() //gml_Script_anon@4173@gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_anchor_v", function(argument0) //gml_Script_anon@4467@gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
...
variable_global_set("meta_shell_set_anchor_v", function() //gml_Script_anon@4855@gml_Object_obj_shell_Other_10
{
    return 
    {
...
variable_global_set("sh_shell_set_anchor_h", function(argument0) //gml_Script_anon@5211@gml_Object_obj_shell_Other_10
{
    if (array_length(argument0) > 1)
    {
...
variable_global_set("meta_shell_set_anchor_h", function() //gml_Script_anon@5599@gml_Object_obj_shell_Other_10
{
    return 
    {
