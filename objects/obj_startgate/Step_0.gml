...
{
    pizza = 1
    if ((!boss) && (!global.SUGARY))
    {
        with (gml_Script_instance_create(x, (y - obj_screensizer.actual_height), obj_startgate_pizza))
        {
            y_to = (other.y - 125)
            highscore = []
            highscorepos = 0
    ...
    {
        with (gml_Script_instance_create(x, (y - 125), obj_startgate_hats))
        {
