...
if (global.SUGARY && distance_to_object(obj_player) < 50)
{
    var yy = (y + 144)
    ...
    if (highscore > 0)
    {
        draw_text(x, (yy - 252), embed_value_string(gml_Script_lang_get_value_newline("sugarygate_line1"), [highscore, (laps + 1)]))
        draw_text(x, (yy - 278), embed_value_string(gml_Script_lang_get_value_newline("sugarygate_line2"), [secret_count, 3]))
    }
    for (var i = 0; i < 5; i++)
    {
        var x_pos = (-100 + (50 * i))
