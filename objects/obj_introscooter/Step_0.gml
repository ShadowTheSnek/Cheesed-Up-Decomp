switch state
{
    ...
    case 3:
        ...
        if (fade >= 1)
        {
            ...
            with (gml_Script_instance_create(246, 405, obj_introprop))
            {
                sprite_index = spr_towerintro_peppino
                depth = -8
            }
            with (gml_Script_instance_create(136, 416, obj_introprop))
            {
                sprite_index = spr_towerintro_gustavo
                depth = -7
            }
            with (gml_Script_instance_create(623, 72, obj_introprop))
            {
