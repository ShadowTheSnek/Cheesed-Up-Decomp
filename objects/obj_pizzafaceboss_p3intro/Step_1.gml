switch introstate
{
    ...
    case 4:
        ...
        if (floor(image_index) == (image_number - 1))
        {
            ...
            var b = proparr[prop]
            prop++
            with (gml_Script_instance_create((x + 42), (y + 300), obj_pizzafacep3_prop))
            {
                depth = (other.depth - 1)
                image_speed = 0.35
                image_xscale = -1
    ...
    case 11:
        ...
        if (obj_player1.x >= (peppermanid.x - 180))
        {
            ...
            {
                if (music != noone)
                    fmod_event_instance_set_parameter(music.event, "state", 3, 0)
            }
            gml_Script_instance_create(0, 0, obj_pizzahead_blackfade)
        }
        break
    case 12:
        if (floor(image_index) == (image_number - 1))
    ...
    case 13:
        ...
        else
        {
            ...
            introstate++
            with (gml_Script_instance_create(obj_player1.x, obj_player1.y, obj_pepperman))
            {
                elitehit = 5
                ...
                alarm[7] = 5
                layer_set_visible("Backgrounds_zigzag1", 0)
                layer_set_visible("Backgrounds_rain", 1)
...
if (sprite_index == spr_pizzahead_phase3_intro2 && floor(image_index) >= 50)
{
    ...
    fmod_event_instance_stop(snd_laugh, 1)
