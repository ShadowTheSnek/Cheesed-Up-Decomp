...
if (attackcycle == 0 && attacked == 0 && floor(image_index) == 13 && sprite_index == spr_cheesedragon_stomp)
{
    ...
    gml_Script_instance_create((playerid.x + -250), -10, obj_bowlingball)
    gml_Script_instance_create((playerid.x + -125), -10, obj_bowlingball)
    gml_Script_instance_create(playerid.x, -10, obj_bowlingball)
    gml_Script_instance_create((playerid.x + 125), -10, obj_bowlingball)
    gml_Script_instance_create((playerid.x + 250), -10, obj_bowlingball)
    attacked = 1
}
