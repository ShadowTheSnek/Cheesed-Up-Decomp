...
switch scene
{
    ...
    case -1:
        if (_switch && (!instance_exists(obj_logoprop)))
        {
            ...
            else
            {
                ...
                peppinopizza = gml_Script_instance_create(-100, 0, obj_introprop)
                peppinopizza.sprite_index = spr_introasset1
                peppinopizza.depth = 0
                tower = gml_Script_instance_create(80, 0, obj_introprop)
                tower.sprite_index = spr_introasset2
                tower.depth = 1
                clouds = gml_Script_instance_create(0, 0, obj_introprop)
                clouds.sprite_index = spr_introasset3
                clouds.depth = 2
                moon = gml_Script_instance_create(0, 0, obj_introprop)
                moon.sprite_index = spr_introasset4
                moon.depth = 3
                bg = gml_Script_instance_create(0, 0, obj_introprop)
    ...
    case 0:
        ...
        if _switch
        {
            ...
            peppino = gml_Script_instance_create(-70, 0, obj_introprop)
    ...
    case 1:
        ...
        {
            instance_destroy(obj_introprop)
            peppino = gml_Script_instance_create(0, 0, obj_introprop)
            peppino.sprite_index = spr_intro_table
            peppino.depth = 0
            tower = gml_Script_instance_create(0, 0, obj_introprop)
    ...
    case 2:
        if _switch
        {
            scenebuffer = 115
            instance_destroy(obj_introprop)
            dramalines = gml_Script_instance_create(0, 0, obj_introprop)
            ...
            bg.depth = 7
            bg1 = gml_Script_instance_create(0, 0, obj_introprop)
            bg1.sprite_index = spr_intro_surprisedsplit1
            bg1.depth = 6
            bg2 = gml_Script_instance_create(0, 0, obj_introprop)
    ...
    case 3:
        ...
        {
            instance_destroy(obj_introprop)
            pizzaface = gml_Script_instance_create(0, 400, obj_introprop)
    ...
    case 4:
        ...
        if (_switch && floor(pizzaface.y) <= 1)
        {
            scenebuffer = 130
            instance_destroy(obj_introprop)
            pizzaface = gml_Script_instance_create(0, 0, obj_introprop)
    ...
    case 6:
        if _switch
        {
            ...
            instance_destroy(bg)
            bg = gml_Script_instance_create(480, 270, obj_tiledintroprop)
            bg.depth = 4
            bg.sprite_index = spr_intro_plot1BG
            bg.hspeed = -1
            bg.vspeed = 1
            bg1 = gml_Script_instance_create(480, 270, obj_tiledintroprop)
            bg1.depth = 3
    ...
    case 7:
        if _switch
        {
            ...
            peppino.image_index = 0
            peppinopizza = gml_Script_instance_create(0, 0, obj_introprop)
            peppinopizza.sprite_index = spr_introasset13
            peppinopizza.depth = 1
            bg = gml_Script_instance_create(0, 0, obj_tiledintroprop)
            bg.depth = 4
    ...
    case 10:
        ...
        {
            instance_destroy(obj_introprop)
            peppino = gml_Script_instance_create(-130, 386, obj_playerprop)
            peppino.alarm[0] = 1
            peppino.fake_hsp = 12
            peppino.sprite_index = spr_player_mach
            peppino.image_speed = 0.5
            pizzaface = gml_Script_instance_create(-130, 200, obj_introprop)
    ...
    case 11:
        ...
        if _switch
        {
            ...
            scenebuffer = 180
            instance_destroy(obj_introprop)
            peppino = gml_Script_instance_create(-50, 100, obj_introprop)
            peppino.sprite_index = spr_intro_running
            peppino.depth = -15
            bg = gml_Script_instance_create(0, -100, obj_introprop)
            bg.sprite_index = spr_introasset8
            bg.depth = -14
            bg2 = gml_Script_instance_create(0, 100, obj_tiledintroprop)
    ...
    case 12:
        ...
        if _switch
        {
            ...
            scenebuffer = 60
            instance_destroy(obj_introprop)
            peppino = gml_Script_instance_create(200, 386, obj_playerprop)
            peppino.fake_hsp = 12
            peppino.alarm[0] = 1
            peppino.sprite_index = spr_player_mach
            peppino.image_speed = 0.5
            pizzaface = gml_Script_instance_create(400, 200, obj_introprop)
            pizzaface.sprite_index = spr_pizzaface
            pizzaface.image_speed = 0.35
        }
        break
    case 13:
        ...
        if _switch
        {
            ...
            scene++
            scenebuffer = 150
            slime1 = gml_Script_instance_create(1300, 386, obj_introprop)
            slime1.sprite_index = spr_slimeidle
            slime1.image_speed = 0.35
            slime2 = gml_Script_instance_create(1400, 386, obj_introprop)
    ...
    case 16:
        ...
        if _switch
        {
            gustavo = gml_Script_instance_create(0, 300, obj_introprop)
    ...
    case 17:
        ...
        if _switch
        {
            instance_destroy(obj_introprop)
            layer_x("Backgrounds_4", 0)
            peppino = gml_Script_instance_create(-700, 386, obj_playerprop)
            peppino.alarm[0] = 1
            peppino.sprite_index = spr_player_mach4
            peppino.image_speed = 0.5
            pizzaface = gml_Script_instance_create(-700, 200, obj_introprop)
            pizzaface.sprite_index = spr_pizzaface
            pizzaface.image_speed = 0.35
            gustavo = gml_Script_instance_create((room_width / 2), 386, obj_playerprop)
            gustavo.spr_palette = spr_peppalette
            gustavo.sprite_index = spr_intro_gustavomap
            stick = gml_Script_instance_create((room_width * 0.55), 200, obj_introprop)
    ...
    case 18:
        ...
        if (gustavo.sprite_index == spr_intro_gustavomap)
        {
            ...
            {
                gml_Script_instance_create((peppino.x + 16), peppino.y, obj_bangeffect)
        ...
        if (stick.sprite_index == spr_intro_stick1)
        {
            ...
            {
                gml_Script_instance_create((pizzaface.x + 16), pizzaface.y, obj_bangeffect)
    ...
    case 19:
        if (_switch && (!obj_genericfade.fadein))
        {
            ...
            scene++
            scenebuffer = 115
            peppinobg = gml_Script_instance_create(0, 0, obj_introprop)
            ...
            pizzaface.depth = 1
            bg2 = gml_Script_instance_create(0, 0, obj_tiledintroprop)
    ...
    case 21:
        if _switch
        {
            ...
            boss = gml_Script_instance_create(0, -540, obj_introprop)
    ...
    case 22:
        ...
        if (_switch && boss.y == 0)
        {
            ...
            {
                scenebuffer = 40
                boss = gml_Script_instance_create(0, (540 * bossdir), obj_introprop)
                bossdir *= -1
    ...
    case 24:
        ...
        {
            instance_destroy(obj_introprop)
            title = gml_Script_instance_create(480, 270, obj_introprop)
