...
if (!trickytreat)
{
    ...
    gml_Script_instance_create(bbox_left, bbox_top, obj_pumpkineffect)
if active
{
    ...
    gamesave_async_save()
    notification_push((58 << 0), [count])
    var txt = gml_Script_lang_get_value("pumpkin_text2")
    if (count <= 1)
        txt = gml_Script_lang_get_value("pumpkin_text1")
