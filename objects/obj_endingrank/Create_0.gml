...
percentage = _perc
percvisual = 0
text = [[0, concat(gml_Script_lang_get_value("rank_totaltime"), hours, ":", mins, ":", secs)], [0, concat(gml_Script_lang_get_value("rank_totaldamage"), damage)], [0, concat(gml_Script_lang_get_value("rank_totalscore"), _score)], [0, concat(gml_Script_lang_get_value("rank_totalenemies"), _enemies)]]
text_pos = 0
