if (app_scale <= 0)
    return;
var appa = true
if (instance_exists(obj_player) && (global.panic || global.snickchallenge) && global.panicbg >= 2 && (!instance_exists(obj_ghostcollectibles)))
    appa = clamp(lerp(1, 0.5, (global.wave / global.maxwave)), 0.01, 1)
if (appa == true)
{
    draw_set_alpha(1)
