...
if (playerid.state != states.rocket && playerid.gusdashpadbuffer <= 0 && playerid.state != states.mach3 && playerid.ratmount_movespeed < 12 && playerid.state != states.crouchslide && playerid.state != states.shoulderbash && (!((playerid.character == "S" && (playerid.sprite_index == playerid.spr_mach4 || playerid.sprite_index == playerid.spr_crazyrun)))))
    instance_destroy()
