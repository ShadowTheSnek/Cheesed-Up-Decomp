...
with (instance_place(x, y, obj_solid))
{
    ...
    if (object_index == obj_secretbigblock || object_index == obj_secretbigblock2 || object_index == obj_secretblock || object_index == obj_secretblock2 || object_index == obj_secretmetalblock)
    {
