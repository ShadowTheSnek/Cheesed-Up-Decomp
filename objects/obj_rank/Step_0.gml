if sugary
{
    ...
    {
        if (global.rank == "d" || global.rank == "f")
        {
            obj_endlevelfade.rank = 1
            self.setcolors(109, 121, 134, 84, 87, 99)
        }
        if (global.rank == "c")
        {
            obj_endlevelfade.rank = 2
            self.setcolors(103, 190, 84, 67, 122, 28)
        }
        if (global.rank == "b")
        {
            obj_endlevelfade.rank = 3
            self.setcolors(121, 159, 221, 51, 95, 196)
        }
        if (global.rank == "a")
        {
            obj_endlevelfade.rank = 4
            self.setcolors(178, 78, 78, 99, 43, 29)
        }
        if (global.rank == "s")
        {
            obj_endlevelfade.rank = 5
            self.setcolors(182, 116, 25, 143, 83, 0)
        }
        if (global.rank == "p")
        {
            obj_endlevelfade.rank = 5
            if check_sugarychar()
                self.setcolors(188, 108, 143, 134, 40, 66)
            else
                self.setcolors(152, 80, 248, 80, 0, 184)
        }
...
if brown
{
    ...
    if sugary
    {
        ...
        if ((obj_player1.key_jump || obj_player1.key_slap2) && event == 1)
        {
            event = 2
