...
if (!trapped)
{
    if (obj_player1.state == states.ratmountgrind || obj_player1.state == states.ratmountladder || obj_player1.state == states.ratmountcrouch || obj_player1.state == states.door || obj_player1.state == states.tumble)
    {
        wait = 1
