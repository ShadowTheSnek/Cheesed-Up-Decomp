...
function boss_destroy@gml_Object_obj_mrstickboss_Create_0(argument0) //gml_Script_boss_destroy@gml_Object_obj_mrstickboss_Create_0
{
...
function boss_hurt@gml_Object_obj_mrstickboss_Create_0(argument0, argument1) //gml_Script_boss_hurt@gml_Object_obj_mrstickboss_Create_0
{
    if (targetstunned > 0)
    {
...
function boss_hurt_noplayer@gml_Object_obj_mrstickboss_Create_0(argument0) //gml_Script_boss_hurt_noplayer@gml_Object_obj_mrstickboss_Create_0
{
    if (targetstunned > 0)
    {
        targetstunned -= targetstunnedminus[(phase - 1)]
...
function player_hurt@gml_Object_obj_mrstickboss_Create_0(argument0, argument1) //gml_Script_player_hurt@gml_Object_obj_mrstickboss_Create_0
{
