...
if start
{
    ...
    draw_sprite(spr_secretsleft, 0, 64, (obj_screensizer.actual_height - 60))
    draw_text_color(64, (obj_screensizer.actual_height - 60), string(array_length(levels)), c_white, c_white, c_white, c_white, 1)
}
