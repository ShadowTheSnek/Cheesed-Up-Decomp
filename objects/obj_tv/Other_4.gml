...
switch global.leveltosave
{
    ...
    case "beach":
        tv_bg_index = 9
        tv_bg.sprite = spr_gate_plageBG
        break
    case "factory":
        tv_bg_index = 15
        tv_bg.sprite = spr_gate_industrialBG
        break
    case "city":
        tv_bg_index = 13
        tv_bg.sprite = spr_gate_streetBG
        break
    case "oldsewer":
        tv_bg_index = 14
        tv_bg.sprite = spr_gate_sewerBG
        break
    case "oldfactory":
        tv_bg_index = 15
        tv_bg.sprite = spr_gate_industrialBG
    ...
    case "oldfreezer":
        tv_bg_index = 16
        tv_bg.sprite = spr_gate_freezerBG
        break
    case "golf":
        tv_bg_index = 12
        break
    ...
    case "desert":
        tv_bg_index = 5
        tv_bg.sprite = spr_gate_badlandBG
        break
    case "entryway":
        tv_bg_index = 0
        break
