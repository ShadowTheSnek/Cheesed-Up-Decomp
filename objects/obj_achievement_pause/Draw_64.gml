...
var xpad = 100
var xx = ((obj_screensizer.actual_width - (xpad * 2)) / array_length(achievements))
xx += xpad
var yy = (obj_screensizer.actual_height / 3)
...
for (var i = 0; i < array_length(achievements); i++)
{
    ...
    draw_sprite_ext(sprite, ix, (xx + (((obj_screensizer.actual_width / 2) - xx) * i)), yy, 1, 1, 0, c_white, (i == achievement ? 1 : 0.5))
}
if (achievement > -1)
{
    var ach = achievements[achievement]
    var txt = concat(ach.name, "\n\n", ach.description)
    draw_text_color((obj_screensizer.actual_width / 2), (yy + 75), txt, c_white, c_white, c_white, c_white, 1)
}
...
if (achievement != -1)
    c = 8421504
draw_text_color(52, 52, gml_Script_lang_get_value("option_back"), c, c, c, c, 1)
