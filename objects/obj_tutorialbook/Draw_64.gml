...
if showgranny
{
    ...
    draw_sprite(rope_spr, rope_img, ((obj_screensizer.actual_width - 64) + text_wave_x), (text_y + text_wave_y))
}
...
scr_draw_text_arr((xx + text_contentpad), (yy + text_contentpad), text_arr, text_color, 1, (2 << 0), 
{
    offset: 1
}
)
