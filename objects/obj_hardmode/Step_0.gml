global.hardmode = global.MOD.HardMode
if global.hardmode
{
...
if (global.hardmode && (!((room == strongcold_endscreen || room == rank_room || room == timesuproom || room == Realtitlescreen || room == characterselect || instance_exists(obj_titlecard)))))
