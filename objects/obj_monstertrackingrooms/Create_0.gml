...
function robot_create@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1) //gml_Script_robot_create@gml_Object_obj_monstertrackingrooms_Create_0
{
    if (!instance_exists(obj_robotmonster))
    {
        var _inst = gml_Script_instance_create(x, y, obj_robotmonster)
...
function blob_create@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1) //gml_Script_blob_create@gml_Object_obj_monstertrackingrooms_Create_0
{
    if (!instance_exists(obj_blobmonster))
    {
        _inst = gml_Script_instance_create(x, y, obj_blobmonster)
        _dir = monster_dir[1]
        with (_inst)
        {
            fake = argument1
...
function puppet_create@gml_Object_obj_monstertrackingrooms_Create_0() //gml_Script_puppet_create@gml_Object_obj_monstertrackingrooms_Create_0
{
    instance_create_unique(0, 0, obj_puppetmonster)
}

function hillbilly_create@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1) //gml_Script_hillbilly_create@gml_Object_obj_monstertrackingrooms_Create_0
{
    if (!instance_exists(obj_hillbillymonster))
    {
        _inst = gml_Script_instance_create(x, y, obj_hillbillymonster)
        _dir = monster_dir[3]
        with (_inst)
        {
            fake = argument1
...
function grid_meeting@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1) //gml_Script_grid_meeting@gml_Object_obj_monstertrackingrooms_Create_0
{
...
function grid_length_x@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1, argument2) //gml_Script_grid_length_x@gml_Object_obj_monstertrackingrooms_Create_0
{
    var count = 0
...
function room_place@gml_Object_obj_monstertrackingrooms_Create_0(argument0, argument1) //gml_Script_room_place@gml_Object_obj_monstertrackingrooms_Create_0
{
    if (argument0 < 0 || argument0 > (map_width - 1) || argument1 < 0 || argument1 > (map_height - 1))
        return -4;
