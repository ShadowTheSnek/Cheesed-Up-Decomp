if (player < 0 && start)
{
    if (other.state != (297 << 0) && other.state != states.backbreaker && other.state != states.chainsaw && other.state != states.hit && other.state != states.gotoplayer)
    {
        ...
        player.hurted = 1
        player.state = (297 << 0)
        with (gml_Script_instance_create(player.x, player.y, obj_parryeffect))
